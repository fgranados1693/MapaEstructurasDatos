...
public class RutaCortaController implements Initializable {
    ...
    public void mostrarPeso (){
        ...
        int peso = pControlador.PesoDijsktra();
        String distancia = String.valueOf(peso);
        inputPeso.setText(distancia);
    }

    public void desplegarRuta(ArrayList<String> listaPaises) {
